...
function Home(){
  ...
  <div className="intro">
    ...
    <div className="project1">
        ...
        <a id="image" href="https://lendmybike.herokuapp.com/"><img src="https://i.imgur.com/nKoHWeU.gif" alt="" width="1000"/></a>
    ...
    <div className="project2">
        ...
        <a id="image" href="https://hellsaur.github.io/daredevil/"><img src="https://i.imgur.com/uxKPxcC.gif" alt="" width="1000"/></a>
    ...
    <div className="project3">
        ...
        <a id="image" href="https://shielded-garden-81038.herokuapp.com/"><img src="https://i.imgur.com/7AuAAE2.gif" alt="" width="1000"/></a>
