...
function Home(){
  ...
  <div className="name"></div>
    ...
    <div className="project1">
        ...
        <p><h2>Rent My Bike Web-App</h2>App that allows a user to rent a bike from a certain number
    ...
    <div className="project2">
        ...
        <p><h2>DareDevil Website</h2>Daredevil is a informative web app. You can learn more about each character and video stories
        of the casts and comic characters of "Marvel's Daredevil" TV-show <br/>
        <br/>
    ...
    <div className="project3">
        ...
        <p><h2>Workout  Web-App</h2>Workout app that allows the user to work at the gym or at home.
